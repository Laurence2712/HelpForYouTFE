 ...
 */
final class Version20200528172640 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE roles_id role_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE role_id roles_id INT NOT NULL');
    }
}
