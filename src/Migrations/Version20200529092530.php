 ...
 */
final class Version20200529092530 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users DROP image_size, DROP updated_at');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users ADD image_size INT DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL');
    }
}
